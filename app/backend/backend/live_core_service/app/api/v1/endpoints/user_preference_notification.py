...
user_router = APIRouter(tags=["User Preferences & Notifications - 用户"])
admin_router = APIRouter(tags=["User Preferences & Notifications - 管理"])


# ==================== User Preferences API ====================

@user_router.get("/users/me/preferences")
...
@user_router.patch("/users/me/preferences")
...
@user_router.get("/users/me/notifications")
...
@user_router.get("/users/me/notifications/unread-count")
...
@user_router.get("/users/me/notifications/{notification_id}")
...
@user_router.post("/users/me/notifications/{notification_id}/read")
...
@user_router.post("/users/me/notifications/read-all")
...
@admin_router.patch("/notifications/{notification_id}")
...
@admin_router.post("/notifications/batch-delete")
