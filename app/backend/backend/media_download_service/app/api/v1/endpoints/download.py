...
@download_router.post("/tasks", response_model=ResponseModel[DownloadTask])
...
@download_router.get("/tasks", response_model=ResponseModel[PageResponse[DownloadTask]])
...
@download_router.get("/tasks/crawl-import-status")
...
@download_router.get("/tasks/{task_id}", response_model=ResponseModel[DownloadTask])
...
@download_router.put("/tasks/{task_id}", response_model=ResponseModel[DownloadTask])
...
@download_router.delete("/tasks/{task_id}", response_model=ResponseModel)
...
@download_router.post("/tasks/{task_id}/start", response_model=ResponseModel[DownloadTask])
...
@download_router.post("/tasks/{task_id}/retry", response_model=ResponseModel[DownloadTask])
...
@download_router.post("/tasks/{task_id}/failures", response_model=ResponseModel[DownloadFailure])
...
@download_router.get("/tasks/{task_id}/failures", response_model=ResponseModel[PageResponse[DownloadFailure]])
...
@download_router.post("/tasks/{task_id}/videos", response_model=ResponseModel[DownloadedVideo])
...
@download_router.get("/tasks/{task_id}/videos", response_model=ResponseModel[PageResponse[DownloadedVideo]])
...
@download_router.post("/tasks/{task_id}/failures/{failure_id}/retry", response_model=ResponseModel[DownloadFailure])
...
@download_router.post("/tasks/{task_id}/failures/{failure_id}/abandon", response_model=ResponseModel[DownloadFailure])
...
@download_router.post("/failures/{failure_id}/retry", response_model=ResponseModel[DownloadFailure])
def retry_failure(
    failure_id: uuid.UUID,
    current_user: dict = Depends(get_current_user),
    db: Session = Depends(get_db)
...
@download_router.post("/failures/{failure_id}/abandon", response_model=ResponseModel[DownloadFailure])
def abandon_failure(
    failure_id: uuid.UUID,
    current_user: dict = Depends(get_current_user),
    db: Session = Depends(get_db)
...
@download_router.get("/videos/{video_id}", response_model=ResponseModel[DownloadedVideo])
...
@download_router.get("/failures", response_model=ResponseModel[PageResponse[DownloadFailure]])
...
@download_router.get("/videos", response_model=ResponseModel[PageResponse[DownloadedVideo]])
def list_all_videos(
        params: PageParams = Depends(),
...
@download_router.get("/failures/{failure_id}", response_model=ResponseModel[DownloadFailure])
...
@download_router.post("/tasks/batch-import")
...
@download_router.post("/tasks/crawl-and-import")
