...
async def list_rules(
    ...
    try:
        ...
        result = ContentSafetyRulePageResult(
            items=[ContentSafetyRuleItem.model_validate(i) for i in items],
            total=total,
            page=page,
            page_size=page_size,
        )
...
async def create_rule(
    ...
    try:
        ...
        return success_response(data=ContentSafetyRuleItem.model_validate(rule).model_dump(mode="json"))
    except PermissionDeniedException as e:
        return JSONResponse(status_code=403, content=error_response(code=3002, message=str(e)))
    except Exception as e:
...
async def update_rule(
    ...
    try:
        ...
        return success_response(data=ContentSafetyRuleItem.model_validate(updated).model_dump(mode="json"))
