"""医学合规违禁词库源数据（add-docs/13 + 12-13 分层策略 V1.1）"""
...
MEDICAL_LEXICON: Dict[str, dict] = {
    "absolute_superlative": {
        "pattern": (
            "顶级,顶尖,极致,终极,全网第一,全国第一,全球第一,行业第一,唯一,首选,首选款,"
            "独家,独家授权,独家配方,绝版,完美,完美无瑕,万能,永不,永久,永久有效,"
            "100%有效,百分百,全覆盖,全覆盖无死角,全网最低,最低价,史上最低,顶级工艺,"
            "最高端,榜首,冠军,最强,最优,无敌,顶级品质"
        ),
        "match_type": "keyword",
    ...
    "absolute_time_scale": {
        "pattern": (
            "永不褪色,永不损坏,永不反弹,全年最低价,十年不遇,千载难逢,仅此一次,仅此一天,"
            "永久保修,终身质保,永久有效,终身会员承诺"
        ),
        "match_type": "keyword",
        "binding_level": "statutory",
    ...
    "absolute_false_promise": {
        "pattern": (
            "根治,根除,永不复发,100%痊愈,百分百见效,立刻见效,马上变好,一次根治,"
            "包治百病,神医,神药,祖传秘方"
        ),
        "match_type": "keyword",
        "binding_level": "statutory",
    ...
    "cure_rate_quantified": {
        "pattern": (
            r"(治愈|有效|康复|好转|痊愈)率?\s*[\d０-９]+[%％％]?"
            r"|[\d０-９]+[%％％]?\s*(治愈|有效|康复|好转|痊愈)"
        ),
        "match_type": "regex",
        "binding_level": "statutory",
        "regulation_ref": "广告法§16;医疗广告办法§7",
    ...
    "medical_treatment_claim": {
        "pattern": (
            "根治,治愈,抗癌,防癌,抗肿瘤,降血脂,修复病灶,根除炎症,缓解肿瘤,"
            "治疗失眠,治疗脚气,治疗皮肤病,治病,药用,药效,药食同疗,"
            "治疗癌症,治疗肿瘤,根治高血压,根治糖尿病"
        ),
        "match_type": "keyword",
        "binding_level": "statutory",
    ...
    "cosmetic_medical_claim": {
        "pattern": (
            "医美级,医用,药妆,祛斑,祛疤,祛痘根治,除皱永久,医美修复,淡化肿瘤,"
            "医疗修复,手术级,无菌医用,美白淡斑根治,根除痘印,无需处方,处方级功效"
        ),
        "match_type": "keyword",
        "binding_level": "statutory",
    ...
    "wellness_false_claim": {
        "pattern": (
            "防癌,长寿,抗衰老,延年益寿,增强抵抗力,包治百病,预防新冠,预防流感,"
            "提高智商,增高,丰胸,壮阳,滋阴,速效壮阳,补肾根治"
        ),
        "match_type": "keyword",
        "binding_level": "statutory",
        "regulation_ref": "广告法§17",
    ...
    "prescription_drug": {
        "pattern": (
            "阿莫西林,奥司他韦,头孢,布洛芬缓释,二甲双胍,胰岛素,硝酸甘油,地西泮,"
            "吗啡,芬太尼,曲马多,左氧氟沙星,阿奇霉素,氯雷他定,洛索洛芬"
        ),
        "match_type": "keyword",
        "binding_level": "statutory",
        "regulation_ref": "广告法§15",
    ...
    "porn_vulgar": {
        "pattern": (
            "私处,私密护理,私处美白,紧致私密,性感露骨,大尺度,房事,助性,成人情趣,"
            "自慰,延时喷剂,增大增粗,床上神器,夜间专用情趣,情侣刺激,私密解压,"
            "魅惑,撩人,成人专用,丰胸产品"
        ),
        "match_type": "porn",
    ...
    "political_sensitive": {
        "pattern": (
            "台独,港独,疆独,藏独,分裂国家,独立建国,反华组织,美化侵略,洗白战犯,"
            "否定历史,抹黑先烈,恶意调侃革命,造谣政务,抹黑公职人员"
        ),
    ...
    "gambling": {
        "pattern": (
            "赌博,下注,彩票,博彩,赔率,稳赢,必中,赌球,线上赌场,棋牌赚钱,刷单赌,"
            "非法彩票,内幕号码,稳赚不赔,赌博技巧,百家乐,德州扑克,线上棋牌"
        ),
        "match_type": "gambling",
        "binding_level": "statutory",
    ...
    "controlled_substance": {
        "pattern": (
            "毒品,冰毒,海洛因,大麻,罂粟,止咳水,精神药品,违禁减肥药,三无激素药,"
            "麻醉剂,管制刀具,弓弩,弹弩,仿真枪,电击棍,管制器具,爆破器材,烟花爆竹私售"
        ),
        "match_type": "keyword",
        "binding_level": "statutory",
    ...
    "financial_fraud": {
        "pattern": (
            "保本,稳赚,零风险,高收益,日入过万,躺赚,复利翻倍,年化30%,内幕股票,荐股,"
            "带单,外汇操盘,虚拟货币挖矿,币圈,比特币,以太坊,资金盘,私募基金代投"
        ),
        "match_type": "keyword",
        "binding_level": "platform",
    ...
    "abuse_discrimination": {
        "pattern": (
            "脑残,去死,地域黑,地域歧视,性别歧视,容貌羞辱,残疾人嘲讽,种族歧视,"
            "性别对立,职业羞辱,身材羞辱,打架,报复,伤人,殴打,自杀,自残,跳楼,"
            "轻生教程,教唆离家出走"
        ),
        "match_type": "keyword",
        "binding_level": "platform",
    ...
    "food_false_claim": {
        "pattern": (
            "防癌,降三高,减肥特效药,减脂根治,代餐瘦20斤,儿童增高,增强记忆力,治病,"
            "排毒,排宿便,根治便秘,无菌无添加,零防腐剂"
        ),
        "match_type": "keyword",
        "binding_level": "statutory",
        "regulation_ref": "广告法§17",
    ...
    "counterfeit_infringement": {
        "pattern": (
            "仿大牌,平替正品,原厂尾单,海关扣押货,走私货,高仿,A货,原版复刻,"
            "盗用商标,明星同款诱导"
        ),
        "match_type": "keyword",
        "binding_level": "platform",
    ...
    "false_endorsement": {
        "pattern": (
            "国检第一,国家级认证,院士研发,三甲医院推荐,专家背书,权威机构唯一推荐,"
            "明星代言,患者亲测,康复案例,疗效证明"
        ),
        "match_type": "keyword",
        "binding_level": "statutory",
    ...
    "cosmetic_surgery": {
        "pattern": (
            "整容,隆鼻,抽脂,割双眼皮,微创手术,注射玻尿酸,肉毒素,整形修复,"
            "手术无痕,永久塑形,溶脂针,水光针"
        ),
        "match_type": "keyword",
        "binding_level": "statutory",
    ...
    "platform_circumvention": {
        "pattern": (
            "内部价,内部通道,内部优惠券,私下转账,微信交易,私发链接,绕过平台,"
            "线下付款,刷单返现,好评返现,五星返利,强制好评"
        ),
        "match_type": "keyword",
        "binding_level": "platform",
    ...
    "superstition": {
        "pattern": (
            "算命,占卜,看风水,改运,符咒,跳大神,算命预测,改命,开光招财,"
            "辟邪神器,封建迷信治病,塔罗预测运势"
        ),
        "match_type": "keyword",
        "binding_level": "statutory",
...
# DROP 审计：禁止再次进入 pattern 的裸词（验收/回归用）
...
def build_medical_rules(text_field_matrix: dict[str, List[str]]) -> List[dict]:
    """按 scene × field 矩阵生成医学合规规则（含分档 action / D 档弱 seed）"""
    rules: List[dict] = []
