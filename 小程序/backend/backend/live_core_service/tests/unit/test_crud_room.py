...
@pytest.mark.asyncio
async def test_delete_room_related_cascades_user_subscriptions(db_session, test_user):
    """
    16-D4：delete_room_related 应物理删除 room/session 级内容订阅。
    """
