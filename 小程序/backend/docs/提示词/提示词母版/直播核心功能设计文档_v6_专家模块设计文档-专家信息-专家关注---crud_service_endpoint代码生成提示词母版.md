...
#### **2. 核心上下文 (Core Context)**
  ...
  * **内容来源 (Design Doc)**: `["直播核心功能设计文档_v6_专家模块设计文档-专家信息-专家关注.md"]`
...
1.  `直播核心功能设计文档_v6_专家模块设计文档-专家信息-专家关注---CRUD 层函数代码生成提示词文档` （直接用于指导AI生成代码）
2.  `直播核心功能设计文档_v6_专家模块设计文档-专家信息-专家关注---Service 层和 API 层函数代码生成提示词文档` （直接用于指导AI生成代码）