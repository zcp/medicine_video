...
- **数据隔离**：每个公众号仅能查看/管理与其关联的直播间列表（通过 `GET /api/v1/official-accounts/{account_id}/rooms` 实现）
...
- **Admin Auth**：管理端接口需 JWT + `ADMIN` 或 `SUPERADMIN`；**CSM 核心接口** `GET /api/v1/official-accounts/{account_id}/rooms` 需 JWT，鉴权规则见 4. API 设计（仅 ADMIN 可调或按业务扩展「当前用户与公众号绑定」校验，本版采用仅 ADMIN 可调）
...
**Endpoint**: `GET /api/v1/admin/official-accounts`
...
**Endpoint**: `GET /api/v1/admin/official-accounts/{account_id}`
...
**Endpoint**: `POST /api/v1/admin/official-accounts`
...
**Endpoint**: `PATCH /api/v1/admin/official-accounts/{account_id}`
...
**Endpoint**: `DELETE /api/v1/admin/official-accounts/{account_id}`
...
**Endpoint**: `GET /api/v1/rooms/{room_id}/official-accounts`
...
**Endpoint**: `POST /api/v1/admin/rooms/{room_id}/official-accounts`
...
**Endpoint**: `DELETE /api/v1/admin/rooms/{room_id}/official-accounts/{account_id}`
...
**Endpoint**: `GET /api/v1/official-accounts/{account_id}/rooms`
...
- 路由挂载：/api/v1/admin/official-accounts、/api/v1/admin/official-accounts/{account_id}（GET 详情）、/api/v1/rooms/{room_id}/official-accounts、/api/v1/admin/rooms/{room_id}/official-accounts、/api/v1/official-accounts/{account_id}/rooms。
- JWT 与权限配置与主文档 B 一致。
