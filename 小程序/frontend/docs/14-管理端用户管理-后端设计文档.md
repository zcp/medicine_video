...
**版本**: V1.1  
**日期**: 2026-07-14  
**状态**: ✅ 骨架已实现可联调；**权限/开播/吊销等语义以 V2 为准（部分待开发）**  
**基于**: 《10-用户认证与管理-后端设计文档.md》(V1.2)、《用户模块设计文档.md》(V4.0)  
**修订文档**: 《[14-管理端用户管理-V2-账号能力模型与权限修订设计文档](./14-管理端用户管理-V2-账号能力模型与权限修订设计文档.md)》

> **修订说明（2026-08-07）**  
> 开播资格（`can_stream`）、ADMIN/SUPERADMIN 职责收敛、封禁/撤权会话吊销、运营检索等，以  
> 《[14-管理端用户管理-V2-账号能力模型与权限修订设计文档](./14-管理端用户管理-V2-账号能力模型与权限修订设计文档.md)》**为准**。  
> **V2.2 已裁剪**：专家认领、品牌成员、品牌货架商品 **不做**；保留专家页、Admin 专家档案、品牌主体（CRUD/挂房挂专题）。  
...
> 完整能力模型（`can_stream`、会话吊销等）见 《14-…-V2-账号能力模型与权限修订设计文档》。
...
> **本节已按 V2 重排。** 下列「V1 旧建议」降级，完整方案见 《14-…-V2-账号能力模型与权限修订设计文档》。
...
- [x] ~~P1：专家认领 `/experts/me`~~ → **V2.2 永久不做**（保留 Admin 专家档案）
- [x] ~~P2：品牌成员 + 货架商品~~ → **V2.2 永久不做**（保留品牌主体 CRUD/挂靠）
